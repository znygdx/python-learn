...
#对脚本md5处理
total_final.append('TapDataBaseAfter@9.2.10@11ec9eaeba4185bdc0cc6c3d68e92dde')
...
#对动态库版本处理
servlib = {'libt2sdkWrapper.so@@1c4b130788f8a58aa3f6f4e1a77b7aa8':'libt2sdkWrapper.so@3.7.1.6@1c4b130788f8a58aa3f6f4e1a77b7aa8','libquickfix3_1.so@@31bc3926e8e2d520d6c8cd9d4062c4af':'libquickfix3_1.so@9.3.0.2@31bc3926e8e2d520d6c8cd9d4062c4af','libiTapTradeAPI.so@@af6fea2b797c4e06d7e92c359e75d114':'libiTapTradeAPI.so@9.3.1.3@af6fea2b797c4e06d7e92c359e75d114','libcryptoapp.so@@f28c885a6f4ddcb824b68429147ad29c':'libcryptoapp.so@5.6.5@f28c885a6f4ddcb824b68429147ad29c','libcurl.so.4@@d105a44fa19326b3fdfac85009e85250':'libcurl.so.4@1.2.0.4@d105a44fa19326b3fdfac85009e85250','libcryptolme.so@@f28c885a6f4ddcb824b68429147ad29c':'libcryptolme.so@5.6.5@f28c885a6f4ddcb824b68429147ad29c'}
...
if not os.path.exists('d:\\修订10'):
    os.makedirs('d:\\修订10')
with open('d:\\修订10\\serverinfo','wb') as f:
